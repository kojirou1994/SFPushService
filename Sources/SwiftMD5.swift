...
private func F(b: Word, c: Word, d: Word) -> Word {
    return (b & c) | ((~b) & d)
}

private func G(b: Word, c: Word, d: Word) -> Word {
    return (b & d) | (c & (~d))
}

private func H(b: Word, c: Word, d: Word) -> Word {
    return b ^ c ^ d
}

private func I(b: Word, c: Word, d: Word) -> Word {
    return c ^ (b | (~d))
}
...
extension String {
    public var md5: String {
        return encodeMD5Digest(digest: md5Digest)
    }
